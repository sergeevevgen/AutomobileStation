...
namespace WpfStoreKeeper
{
    ...
    public partial class GetSparePartsListWindow : Window
    {
        ...
        public GetSparePartsListWindow(IWorkTypeLogic workTypeLogic, IReportLogic reportLogic)
        {
            InitializeComponent();
        ...
        private void ButtonExcel_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    _reportLogic.SaveWorkTypesToExcelFile(new ReportBindingModel
                    {
        ...
        private void ButtonWord_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                if (dialog.ShowDialog() == true)
                {
                    ...
                    _reportLogic.SaveWorkTypesToWordFile(new ReportBindingModel
                    {
                        FileName = dialog.FileName,
                        WorkTypes = list
                    });
